...
# Load project
 ...
 eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -GWR_NR=$1 -GRD_NR=$2 -Gwrite_order=$3 -Gread_order=$4 -GCASE_NAME=$5 -GSEED_VAL=$6 -sva top
...
if {[batch_mode] == 0} {
  #salveaza toate semnalele in baza de date in vsim.wlf
  eval log -r /* 
